...
uint64_t test_post(thread_context_t* threadContext) {
    ...
    uint64_t a = memory[10];
    uint64_t b = memory[11];
    uint64_t c = memory[12];
    uint64_t d = memory[13];
    uint64_t e = memory[14];
    uint64_t f = memory[15];
    uint64_t g = memory[16];
    uint64_t h = memory[17];
